...
AS $$
DECLARE
  project_url TEXT := 'https://culilojqcahqgdfdswsc.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImN1bGlsb2pxY2FocWdkZmRzd3NjIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcxNjk0NjEzNiwiZXhwIjoyMDMyNTIyMTM2fQ.2sQITZyDnLqK54LVl3UFgm6OfyRx0UAVQgHLZjyzPnQ'; -- full access needed for http request to storage
